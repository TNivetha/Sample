...
public class TrackAndTracePage {
	...
	WebDriver driver;
	By consignMentNumber = By.xpath("//label[contains(text(),'Consignment Number')]/following::input[1]");
	...
	By consignmentErrorMessage=By.xpath("//span[@data-aura-class='forceActionsText' and contains(text(),'12 digit')]");
