...
public class BookingPage {
	...
	public void getCutoffTime() throws Exception {
		List<WebElement> cutofftimetableColumn=uiTestHelper.waitForObjects(By.xpath("//div[@class='slds-modal__container']//lightning-datatable//table[1]/thead//th"));
		List<WebElement> cutofftimetableRow=uiTestHelper.waitForObjects(By.xpath("//div[@class='slds-modal__container']//table[1]/tbody/tr"));
		...
		for(int j=1;j<=colCount;j++) {		
			WebElement headerValue = uiTestHelper.waitForObject(By.xpath("//div[@class='slds-modal__container']//table[1]/thead/tr[1]/th["+j+"]//span[2]"));
			String header=headerValue.getText();	
			if(j==1) {
				WebElement cutoffType=uiTestHelper.waitForObject(By.xpath("//div[@class='slds-modal__container']//table[1]/tbody/tr["+j+"]/th[1]//lightning-base-formatted-text"));
				map.put(header, cutoffType.getText());
			}else {
			for(int i=1;i<=rowCount;i++) {
				WebElement rowValue = uiTestHelper.waitForObject(By.xpath("//div[@class='slds-modal__container']//table[1]/tbody/tr["+i+"]/td["+j+"]//lightning-base-formatted-text"));
