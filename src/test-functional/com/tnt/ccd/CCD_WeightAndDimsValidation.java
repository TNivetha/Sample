...
*/
	public void consignmentWeightandDimValidation(String testCase, String Country, String length, String width,
		...
		try {
			...
			driver.findElement(By.xpath("//input[@name='[object Object]']")).click();
			driver.findElement(By.xpath("//lightning-base-combobox-item[@data-value='" + consignmentType + "']"))
					.click();
			WebElement quantity = driver.findElement(By.xpath("(//input[@name='quantity'])[1]"));
			quantity.clear();
			quantity.sendKeys("1");
			driver.findElement(By.xpath("(//label[text()='Length (cm)']/following::input[1])[1]")).sendKeys(length,
					Keys.TAB);
			...
			driver.findElement(By.xpath("(//label[text()='Width (cm)']/following::input[1])[1]")).sendKeys(width,
					Keys.TAB);
			...
			driver.findElement(By.xpath("(//label[text()='Height (cm)']/following::input[1])[1]")).sendKeys(height,
					Keys.TAB);
			...
			driver.findElement(By.xpath("(//label[text()='Weight (kg)']/following::input[1])[1]")).sendKeys(weight,
					Keys.TAB);
