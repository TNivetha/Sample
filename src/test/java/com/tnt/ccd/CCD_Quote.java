...
public class CCD_Quote extends Driver {
	...
	public void beforeClass() {
		String Keys = Test_Initializer.BeforeClass("CCD_Quote");
	...
	public void login(String env) throws Exception {
		System.out.println("Quote: " + Thread.currentThread().getName());
		ciQuote.ci_login(env);
	...
	@Test(groups = { "quote", "defaultPreferredCollectionTime_convertQuoteToBooking" })
	...
	@Test(groups = { "quote", "serviceSelection" })
	public void serviceSelection_onQuoteSummary() throws Exception {
		ciQuote.serviceSelection_onQuoteSummary();
	}

	@Test(groups = { "quote", "errorMsg_serviceSelection" })
	public void validateErrorMessagewhileserviceSelection_onQuoteSummary() throws Exception {
		ciQuote.validateErrorMessagewhileserviceSelection_onQuoteSummary();
	}

	@Test(groups = { "quote", "quote_expiryDate" })
	public void validateQuoteExpiration_before_bookingConversion() throws Exception {
		ciQuote.validateQuoteExpiration_before_bookingConversion();
	}

	@Test(groups = { "quote", "WeightAndDimsMaintained" })
	public void verifyWeightAndDims_maintained_consignmentInfoPage_for_Quote() throws Exception {
		ciQuote.verifyWeightAndDims_maintained_consignmentInfoPage_for_Quote();
	}
