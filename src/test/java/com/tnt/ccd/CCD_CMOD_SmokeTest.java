...
public class CCD_CMOD_SmokeTest extends Driver
{
	...
	@Test(groups= {"smokeTest","PurpleParentChildTrack"})
	public void trackAndTrace_ValidationOnMasterandChildTrackingNo() throws Exception
	{
		CCD_Connectivity connectivity = new CCD_Connectivity();
		connectivity.trackAndTrace_ValidationOnMasterandChildTrackingNo();
	}
